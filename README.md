...
Cross-cutting operating rules common to every agent — brevity, the comment/docs
and test doctrine, the environment/CWD conventions, the messaging heredoc form,
the `pm workflow show` reminder, surfacing out-of-scope problems, what "the
user" means — live in a single bundled `pm-baseline.md`
